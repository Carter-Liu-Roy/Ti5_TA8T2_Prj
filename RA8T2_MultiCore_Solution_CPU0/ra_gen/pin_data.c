...
const ioport_pin_cfg_t g_bsp_pin_cfg_data[] = {
    ...
    
    {
        ...
        .pin_cfg = ((uint32_t) IOPORT_CFG_PERIPHERAL_PIN | (uint32_t) IOPORT_PERIPHERAL_ESC)
    },
    ...
    
    {
        ...
        .pin_cfg = ((uint32_t) IOPORT_CFG_PERIPHERAL_PIN | (uint32_t) IOPORT_PERIPHERAL_DE_SCI0_2_4_6_8)
    },
    ...
    {
        .pin = BSP_IO_PORT_11_PIN_08,
        .pin_cfg = ((uint32_t) IOPORT_CFG_PERIPHERAL_PIN | (uint32_t) IOPORT_PERIPHERAL_ESC)
    },
    
    {
        .pin = BSP_IO_PORT_11_PIN_09,
        .pin_cfg = ((uint32_t) IOPORT_CFG_PERIPHERAL_PIN | (uint32_t) IOPORT_PERIPHERAL_ESC)
    },
    
    {
        .pin = BSP_IO_PORT_11_PIN_10,
        .pin_cfg = ((uint32_t) IOPORT_CFG_PERIPHERAL_PIN | (uint32_t) IOPORT_PERIPHERAL_ESC)
    },
    
    {
        .pin = BSP_IO_PORT_11_PIN_11,
        .pin_cfg = ((uint32_t) IOPORT_CFG_PERIPHERAL_PIN | (uint32_t) IOPORT_PERIPHERAL_ESC)
    },
    
    {
        .pin = BSP_IO_PORT_11_PIN_12,
        .pin_cfg = ((uint32_t) IOPORT_CFG_PERIPHERAL_PIN | (uint32_t) IOPORT_PERIPHERAL_ESC)
    },
    
    {
        .pin = BSP_IO_PORT_11_PIN_13,
        .pin_cfg = ((uint32_t) IOPORT_CFG_PERIPHERAL_PIN | (uint32_t) IOPORT_PERIPHERAL_ESC)
    },
};
