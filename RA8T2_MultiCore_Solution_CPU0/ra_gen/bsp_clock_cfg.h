...
#define BSP_CFG_PLL2R_FREQUENCY_HZ (300000000) /* PLL2R 300000000Hz */
...
#define BSP_CFG_BCLKA_SOURCE (BSP_CLOCKS_SOURCE_CLOCK_PLL1Q) /* BCLKA Src: PLL1Q */
#define BSP_CFG_BCLKA_DIV (BSP_CLOCKS_BCLKA_CLOCK_DIV_10) /* BCLKA Div /10 */
...
#define BSP_CFG_CANFDCLK_DIV (BSP_CLOCKS_CANFD_CLOCK_DIV_5) /* CANFDCLK Div /5 */
#define BSP_CFG_GPTCLK_SOURCE (BSP_CLOCKS_SOURCE_CLOCK_PLL2R) /* GPTCLK Src: PLL2R */
#define BSP_CFG_GPTCLK_DIV (BSP_CLOCKS_GPT_CLOCK_DIV_1) /* GPTCLK Div /1 */
...
#define BSP_CFG_I3CCLK_DIV (BSP_CLOCKS_I3C_CLOCK_DIV_6) /* I3CCLK Div /6 */
...
#define BSP_CFG_OCTACLK_DIV (BSP_CLOCKS_OCTA_CLOCK_DIV_3) /* OCTACLK Div /3 */
#define BSP_CFG_ADCCLK_SOURCE (BSP_CLOCKS_SOURCE_CLOCK_PLL2R) /* ADCCLK Src: PLL2R */
#define BSP_CFG_ADCCLK_DIV (BSP_CLOCKS_ADC_CLOCK_DIV_3) /* ADCCLK Div /3 */
#define BSP_CFG_ESWCLK_SOURCE (BSP_CLOCKS_SOURCE_CLOCK_PLL2P) /* ESWCLK Src: PLL2P */
#define BSP_CFG_ESWCLK_DIV (BSP_CLOCKS_ESW_CLOCK_DIV_4) /* ESWCLK Div /4 */
#define BSP_CFG_ESWPHYCLK_SOURCE (BSP_CLOCKS_SOURCE_CLOCK_PLL2Q) /* ESWPHYCLK Src: PLL2Q */
#define BSP_CFG_ESWPHYCLK_DIV (BSP_CLOCKS_ESWPHY_CLOCK_DIV_32) /* ESWPHYCLK Div /32 */
...
#define BSP_CFG_ESCCLK_SOURCE (BSP_CLOCKS_SOURCE_CLOCK_PLL2R) /* ESCCLK Src: PLL2R */
#define BSP_CFG_ESCCLK_DIV (BSP_CLOCKS_ESC_CLOCK_DIV_3) /* ESCCLK Div /3 */
#define BSP_CFG_DSMIFCLK_SOURCE (BSP_CLOCKS_SOURCE_CLOCK_PLL2R) /* DSMIFCLK Src: PLL2R */
#define BSP_CFG_DSMIFCLK_DIV (BSP_CLOCKS_DSMIF_CLOCK_DIV_2) /* DSMIFCLK Div /2 */
