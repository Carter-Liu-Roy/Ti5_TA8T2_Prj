...
#pragma section="__ctcm_zero"
#pragma section="__stcm_zero"
...
static const bsp_init_zero_info_t zero_list[] =
{
  ...
  {.p_base = (uint32_t *) __section_begin("__ctcm_zero"), .p_limit = (uint32_t *) __section_end("__ctcm_zero"),.type={.copy_64 = 0, .external = 0, .source_type = INIT_MEM_ZERO, .destination_type = INIT_MEM_CTCM}},
  {.p_base = (uint32_t *) __section_begin("__stcm_zero"), .p_limit = (uint32_t *) __section_end("__stcm_zero"),.type={.copy_64 = 0, .external = 0, .source_type = INIT_MEM_ZERO, .destination_type = INIT_MEM_STCM}},
...
#pragma section="__ctcm_from_ospi0_cs1"
#pragma section="__ospi0_cs1_init_ctcm_from_ospi0_cs1"
#pragma section="__ctcm_from_ospi1_cs1"
#pragma section="__ospi1_cs1_init_ctcm_from_ospi1_cs1"
#pragma section="__ctcm_from_data_flash"
#pragma section="__data_flash_init_ctcm_from_data_flash"
#pragma section="__ctcm_from_flash"
#pragma section="__flash_init_ctcm_from_flash"
#pragma section="__stcm_from_ospi0_cs1"
#pragma section="__ospi0_cs1_init_stcm_from_ospi0_cs1"
#pragma section="__stcm_from_ospi1_cs1"
#pragma section="__ospi1_cs1_init_stcm_from_ospi1_cs1"
#pragma section="__stcm_from_data_flash"
#pragma section="__data_flash_init_stcm_from_data_flash"
#pragma section="__stcm_from_flash"
#pragma section="__flash_init_stcm_from_flash"
...
static const bsp_init_copy_info_t copy_list[] =
{
  ...
  {.p_base = (uint32_t *) __section_begin("__ctcm_from_ospi0_cs1"), .p_limit = (uint32_t *) __section_end("__ctcm_from_ospi0_cs1"), .p_load = (uint32_t *) __section_begin("__ospi0_cs1_init_ctcm_from_ospi0_cs1"),.type={.copy_64 = 0, .external = 1, .source_type = INIT_MEM_OSPI0_CS1, .destination_type = INIT_MEM_CTCM}},
  {.p_base = (uint32_t *) __section_begin("__ctcm_from_ospi1_cs1"), .p_limit = (uint32_t *) __section_end("__ctcm_from_ospi1_cs1"), .p_load = (uint32_t *) __section_begin("__ospi1_cs1_init_ctcm_from_ospi1_cs1"),.type={.copy_64 = 0, .external = 1, .source_type = INIT_MEM_OSPI1_CS1, .destination_type = INIT_MEM_CTCM}},
  {.p_base = (uint32_t *) __section_begin("__ctcm_from_data_flash"), .p_limit = (uint32_t *) __section_end("__ctcm_from_data_flash"), .p_load = (uint32_t *) __section_begin("__data_flash_init_ctcm_from_data_flash"),.type={.copy_64 = 0, .external = 0, .source_type = INIT_MEM_DATA_FLASH, .destination_type = INIT_MEM_CTCM}},
  {.p_base = (uint32_t *) __section_begin("__ctcm_from_flash"), .p_limit = (uint32_t *) __section_end("__ctcm_from_flash"), .p_load = (uint32_t *) __section_begin("__flash_init_ctcm_from_flash"),.type={.copy_64 = 0, .external = 0, .source_type = INIT_MEM_FLASH, .destination_type = INIT_MEM_CTCM}},
  {.p_base = (uint32_t *) __section_begin("__stcm_from_ospi0_cs1"), .p_limit = (uint32_t *) __section_end("__stcm_from_ospi0_cs1"), .p_load = (uint32_t *) __section_begin("__ospi0_cs1_init_stcm_from_ospi0_cs1"),.type={.copy_64 = 0, .external = 1, .source_type = INIT_MEM_OSPI0_CS1, .destination_type = INIT_MEM_STCM}},
  {.p_base = (uint32_t *) __section_begin("__stcm_from_ospi1_cs1"), .p_limit = (uint32_t *) __section_end("__stcm_from_ospi1_cs1"), .p_load = (uint32_t *) __section_begin("__ospi1_cs1_init_stcm_from_ospi1_cs1"),.type={.copy_64 = 0, .external = 1, .source_type = INIT_MEM_OSPI1_CS1, .destination_type = INIT_MEM_STCM}},
  {.p_base = (uint32_t *) __section_begin("__stcm_from_data_flash"), .p_limit = (uint32_t *) __section_end("__stcm_from_data_flash"), .p_load = (uint32_t *) __section_begin("__data_flash_init_stcm_from_data_flash"),.type={.copy_64 = 0, .external = 0, .source_type = INIT_MEM_DATA_FLASH, .destination_type = INIT_MEM_STCM}},
  {.p_base = (uint32_t *) __section_begin("__stcm_from_flash"), .p_limit = (uint32_t *) __section_end("__stcm_from_flash"), .p_load = (uint32_t *) __section_begin("__flash_init_stcm_from_flash"),.type={.copy_64 = 0, .external = 0, .source_type = INIT_MEM_FLASH, .destination_type = INIT_MEM_STCM}},
