                                     ...
                                     ethercat_ssc_port_cfg_t const * const p_cfg)
{
    ...
    p_reg_esc_ini->PHYLINK_b.LINKPOL0 =  ETHERCAT_SSC_PORT_CFG_CAT0_LINKSTA_POL;//0-active high  addr: 10   default: low, active:H  need 0
    p_reg_esc_ini->PHYLINK_b.LINKPOL1 =  ETHERCAT_SSC_PORT_CFG_CAT1_LINKSTA_POL;//1-active low   addr: 11   default: High active: L need 1
    ...
    /* Reset hold time */
    R_BSP_SoftwareDelay(1000, BSP_DELAY_UNITS_MILLISECONDS);//p_instance_ctrl->p_cfg->reset_hold_time
