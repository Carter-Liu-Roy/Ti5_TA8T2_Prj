...
void ethercat_phy_target_ics1894_initialize (ethercat_phy_instance_ctrl_t * p_instance_ctrl)
{
     ...
     */
  //  R_ETHERCAT_PHY_Read(p_instance_ctrl, 0x02, &reg);
  //      if(reg != 0xffff)
  //    R_ETHERCAT_PHY_Read(p_instance_ctrl, 0x02, &reg);
   // }
   ...
   //   R_ETHERCAT_PHY_Read(p_instance_ctrl, 0x02, &reg);
    ...
    R_ETHERCAT_PHY_Write(p_instance_ctrl, 0x1E, 0x40C0);//set led0 as LINKSTA
    R_ETHERCAT_PHY_Write(p_instance_ctrl, 0x1F, 0x30);
    
    R_ETHERCAT_PHY_Write(p_instance_ctrl, 0x1E, 0x40C3);//set led1 as ACTSTA
    R_ETHERCAT_PHY_Write(p_instance_ctrl, 0x1F, 0x0320);
