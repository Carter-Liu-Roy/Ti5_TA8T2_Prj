...
#define BSP_TZ_CFG_PSARD (\
            ...
            (((RA_NOT_DEFINED > 0) ? 0U : 1U) << 8) /* DSMIF1 */ | \
            (((RA_NOT_DEFINED > 0) ? 0U : 1U) << 9) /* DSMIF0 */ | \
...
#define BSP_TZ_CFG_DPFSAR ((RA_NOT_DEFINED > 0) ? 0U : 0xED1FFFFFU)
#endif
...
#define BSP_TZ_CFG_CGFSAR (0x3B777FFDU)
#endif
#endif
